...
export const getIndexActiveTravelSelector = createSelector(getIndexActiveTravel, data => data);
export const getIsFilledUpContactsSelector = createSelector(getIsFilledUpContacts, data => data);
